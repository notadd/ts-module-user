...
let OrganizationResolver = class OrganizationResolver {
    ...
    roots() {
        return __awaiter(this, void 0, void 0, function* () {
            let roots = yield this.organizationService.getRoots();
    ...
    children(req, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let children = yield this.organizationService.getChildren(id);
    ...
    usersInOrganization(req, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let users = yield this.organizationService.getUsersInOrganization(id);
...
OrganizationResolver = __decorate([
    ...
    __param(0, common_1.Inject(OrganizationService_1.OrganizationService)),
