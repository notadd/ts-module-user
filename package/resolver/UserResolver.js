...
let UserResolver = class UserResolver {
    ...
    freedomUsers() {
        return __awaiter(this, void 0, void 0, function* () {
            let freedomUsers = yield this.userService.getFreedomUsers();
            return { code: 200, message: '获取所有自由用户成功', freedomUsers };
        });
    }
    recycleUsers() {
        return __awaiter(this, void 0, void 0, function* () {
            let recycleUsers = yield this.userService.getRecycleUsers();
    ...
    userInfos(req, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let userInfos = yield this.userService.userInfos(id);
    ...
    rolesInUser(req, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let roles = yield this.userService.roles(id);
    ...
    permissionsInUser(req, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let permissions = yield this.userService.permissions(id);
...
UserResolver = __decorate([
    ...
    __param(0, common_1.Inject(UserService_1.UserService)),
