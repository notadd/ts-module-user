...
var ModuleResolver = /** @class */ (function () {
    function ModuleResolver(moduleService) {
        this.moduleService = moduleService;
    }
    ModuleResolver.prototype.modules = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modules;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.moduleService.getAll()];
                    case 1:
                        modules = _a.sent();
                        return [2 /*return*/, { code: 200, message: "获取模块信息成功", modules: modules }];
                }
            });
        });
    };
    ...
    ], ModuleResolver.prototype, "modules");
