...
let InfoGroupResolver = class InfoGroupResolver {
    ...
    infoGroups() {
        return __awaiter(this, void 0, void 0, function* () {
            let infoGroups = yield this.infoGroupService.getAll();
    ...
    infoItems(req, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let infoItems = yield this.infoGroupService.getInfoItems(id);
...
InfoGroupResolver = __decorate([
    ...
    __param(0, common_1.Inject(InfoGroupService_1.InfoGroupService)),
    __metadata("design:paramtypes", [InfoGroupService_1.InfoGroupService])
], InfoGroupResolver);
