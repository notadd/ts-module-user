...
let ScoreResolver = class ScoreResolver {
    ...
    getScore(req, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let score = yield this.scoreService.getScore(userId, scoreTypeId);
...
ScoreResolver = __decorate([
    ...
    __param(0, common_1.Inject(ScoreService_1.ScoreService)),
    __metadata("design:paramtypes", [ScoreService_1.ScoreService])
], ScoreResolver);
