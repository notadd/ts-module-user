...
let InfoGroupService = class InfoGroupService {
    ...
    getAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.infoGroupRepository.find();
        });
    }
    getInfoItems(id) {
        return __awaiter(this, void 0, void 0, function* () {
            let infoGroup = yield this.infoGroupRepository.findOneById(id, { relations: ['items'] });
            return infoGroup.items;
        });
    }
    createInfoGroup(name) {
        return __awaiter(this, void 0, void 0, function* () {
            let exist = yield this.infoGroupRepository.findOne({ name });
            if (exist) {
                throw new common_1.HttpException('给定名称name=' + name + '信息组已存在', 407);
            }
            let infoGroup = this.infoGroupRepository.create({ name, default: false, status: true });
            try {
    ...
    updateInfoGroup(id, name) {
        return __awaiter(this, void 0, void 0, function* () {
            let exist = yield this.infoGroupRepository.findOneById(id);
            if (!exist) {
            ...
            if (name !== exist.name) {
                let exist1 = yield this.infoGroupRepository.findOne({ name });
                if (exist1) {
    ...
    addInfoItem(id, infoItemId) {
        return __awaiter(this, void 0, void 0, function* () {
            let group = yield this.infoGroupRepository.findOneById(id, { relations: ['items'] });
            if (!group) {
                throw new common_1.HttpException('给定id=' + id + '信息组不存在', 408);
            }
            if (group.default) {
            ...
            let item = yield this.infoItemRepository.findOneById(infoItemId);
            if (!item) {
            ...
            let find = group.items.find(item => {
                return item.id === id;
            });
            if (find) {
...
InfoGroupService = __decorate([
    ...
    __param(1, typeorm_1.InjectRepository(InfoGroup_entity_1.InfoGroup)),
