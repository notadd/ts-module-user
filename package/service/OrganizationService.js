...
let OrganizationService = class OrganizationService {
    ...
    getRoots() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.organizationRepository.find({ parentId: null });
        });
    }
    getChildren(id) {
        return __awaiter(this, void 0, void 0, function* () {
            let o = yield this.organizationRepository.findOneById(id, { relations: ['children'] });
            if (!o) {
    ...
    createOrganization(name, parentId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let exist = yield this.organizationRepository.findOne({ name });
            if (exist) {
                throw new common_1.HttpException('指定名称name=' + name + '组织已存在', 403);
            }
            let organization = this.organizationRepository.create({ name, parent });
            try {
    ...
    updateOrganization(id, name, parentId) {
        return __awaiter(this, void 0, void 0, function* () {
            let exist = yield this.organizationRepository.findOneById(id);
            if (!exist) {
    ...
    deleteOrganization(id) {
        return __awaiter(this, void 0, void 0, function* () {
            let exist = yield this.organizationRepository.findOneById(id, { relations: ['children'] });
            if (!exist) {
                throw new common_1.HttpException('指定id=' + id + '组织不存在', 404);
            }
    ...
    getUsersInOrganization(id) {
        return __awaiter(this, void 0, void 0, function* () {
            let o = yield this.organizationRepository.findOneById(id, { relations: ['users'] });
            if (!o) {
    ...
    addUsersToOrganization(id, userIds) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let users = yield this.userRepository.findByIds(userIds);
            userIds.forEach(id => {
