...
let ScoreTypeService = class ScoreTypeService {
    ...
    getAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.scoreTypeRepository.find();
        });
    }
    createScoreType(name, type, description) {
        return __awaiter(this, void 0, void 0, function* () {
            let exist = yield this.scoreTypeRepository.findOne({ name });
            if (exist) {
                throw new common_1.HttpException('指定名称name=' + name + '积分类型已存在', 424);
            }
            let scoreType = this.scoreTypeRepository.create({ name, type, default: false, description });
            try {
    ...
    updateScoreType(id, name, type, description) {
        return __awaiter(this, void 0, void 0, function* () {
            let original = yield this.scoreTypeRepository.findOneById(id);
            if (!original) {
    ...
    deleteScoreType(id) {
        return __awaiter(this, void 0, void 0, function* () {
            let exist = yield this.scoreTypeRepository.findOneById(id);
            if (!exist) {
                throw new common_1.HttpException('指定id=' + id + '积分类型不存在', 425);
            }
            if (exist.default) {
    ...
    deleteScoreTypes(ids) {
        return __awaiter(this, void 0, void 0, function* () {
            let exists = yield this.scoreTypeRepository.findByIds(ids);
            ids.forEach(id => {
                let find = exists.find(exist => {
                    return exist.id === id;
                });
                if (!find) {
                    throw new common_1.HttpException('指定id=' + id + '积分类型不存在', 425);
...
ScoreTypeService = __decorate([
    common_1.Component(),
    __param(0, typeorm_1.InjectRepository(ScoreType_entity_1.ScoreType)),
