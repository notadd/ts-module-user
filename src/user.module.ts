...
export class UserModule implements OnModuleInit {
    ...
    */
    async addDefaultInfoGroup() {
        ...
        let nickname: InfoItem = this.infoItemRepository.create({
            id: 1,
            name: 'nickname',
            label: '昵称',
            default: true,
        ...
        let sex: InfoItem = this.infoItemRepository.create({
            id: 2,
            name: 'sex',
            label: '性别',
            default: true,
        ...
        let age: InfoItem = this.infoItemRepository.create({
            id: 3,
            name: 'age',
            label: '年龄',
            default: true,
        ...
        let birthday: InfoItem = this.infoItemRepository.create({
            id: 4,
            name: 'birthday',
            label: '生日',
            default: true,
        ...
        let headPortrait: InfoItem = this.infoItemRepository.create({
            id: 5,
            name: 'headPortrait',
            label: '头像',
            default: true,
        ...
        let sign: InfoItem = this.infoItemRepository.create({
            id: 6,
            name: 'sign',
            label: '签名',
            default: true,
        ...
        let authentication: InfoGroup = this.infoGroupRepository.create({
            id: 2,
            name: 'authentication',
            default: true,
            status: true
        })
        let email: InfoItem = this.infoItemRepository.create({
            id: 7,
            name: 'email',
            label: '邮箱',
            default: true,
        ...
        let realName: InfoItem = this.infoItemRepository.create({
            id: 8,
            name: 'realName',
            label: '姓名',
            default: true,
        ...
        let idNumber: InfoItem = this.infoItemRepository.create({
            id: 9,
            name: 'idNumber',
            label: '身份证号',
            default: true,
        ...
        let idImage: InfoItem = this.infoItemRepository.create({
            id: 10,
            name: 'idImage',
            label: '身份证图片',
            default: true,
        ...
        let cellPhoneNumber: InfoItem = this.infoItemRepository.create({
            id: 11,
    ...
    async addDefaultScoreType() {
        let scoreType1: ScoreType = this.scoreTypeRepository.create({
            id: 1,
            name: '积分',
            type: 'int',
            default: true,
        ...
        let scoreType2: ScoreType = this.scoreTypeRepository.create({
            id: 2,
            name: '贡献',
            type: 'int',
            default: true,
        ...
        let scoreType3: ScoreType = this.scoreTypeRepository.create({
            id: 3,
            name: '威望',
            type: 'int',
            default: true,
        ...
        let scoreType4: ScoreType = this.scoreTypeRepository.create({
            id: 4,
            name: '余额',
            type: 'float',
            default: true,
